...
{
	/*! @class Mat4x4 \file mat4x4.h
	 *  @brief a matrix made up of 4 by 4 components row major
	 *  @author Kay Hennig
	 *  @date 11.08.2020
	 */
	class Mat4x4
	...
	public:
		...
		/*! @brief a unit/indentiy matrix with ones in the main diagonal */
		static const Mat4x4 Identity;
		/*! @brief a matrix with zero in all of its components */
		static const Mat4x4 Zero;

		/*! @brief flips the matrix on the diagional
		 *  @return a new matrix flipped from this matrix
		 */
		...
		/*! @brief multiplies a matrix by a factor
		 *  @return the modified matrix
		 */
		...
		/*! @brief adds a matrix on another one
		 *  @return a new matrix of the sum of them
		 */
		...
		/*! @brief subtracts a matrix on another one
		 *  @return a new matrix of the difference of them
		 */
		inline Mat4x4 operator-(const Mat4x4& v) const
		{
			return Mat4x4
		...
		/*! @brief multplies a matrix on another one
		 *  @return a new matrix of the product of them
		 */
		...
		/*! @brief multplies a matrix with a vector
		 *  @return a new vector transformed by the matrix
		 */
		...
		/*! @brief multplies a matrix by a factor
		 *  @return a new matrix of the product of them
		 */
		...
		/*! @brief compares the matrix with another one by value
		 *  @return matrices are equal by value
		 */
		...
		/*! @brief compares the matrix with another one by value
		 *  @return matrices are not equal by value
		 */
		inline bool operator!=(const Mat4x4& v) const
		{
			return !(*this == v);
		...
		/*! @brief creates a translation matrix from a quaternion
		...
		/*! @brief creates a view matrix from a vecotr
		...
		/*! @brief creates a projection matrix for a orthographics camera
		 *  @param width the horizontal size of the screen
		 *  @param height the vertical size of the screen
		 *  @param nearPlane the closest vector/value possible
		 *  @param farPlane the furthest vector/value possible
		...
		/*! @brief creates a projection matrix for a perspective camera
		 *  @param fov the vertical angle of the camera
		 *  @param aspect the ratio of the screen
		 *  @param nearPlane the closest vector/value possible
		 *  @param farPlane the furthest vector/value possible
		 *  @return a new projection matrix
		 */
