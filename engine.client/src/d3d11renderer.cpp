...
bool D3D11Renderer::Init(AppWindow& window)
{
	...
	factory->MakeWindowAssociation(reinterpret_cast<HWND>(window.GetHandle()), DXGI_MWA_NO_ALT_ENTER);
...
bool Engine::Graphics::D3D11Renderer::Resize(Engine::Core::AppWindow& window)
{
...
void D3D11Renderer::SetActiveCamera(Camera* camera)
{
